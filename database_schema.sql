...
-- Email OTPs table (replaces magic_links)
...
DROP POLICY IF EXISTS "Enable all for server" ON email_otps;
CREATE POLICY "Enable all for server" ON email_otps FOR ALL USING (true);
